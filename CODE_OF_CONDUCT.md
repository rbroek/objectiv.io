...
All complaints will be reviewed and investigated promptly and fairly. The community leaders should aim to have a resolution agreed upon within one week. In the event that a resolution can't be determined in that time, the community leaders will respond to the reporter(s) with an update and projected timeline for resolution.
