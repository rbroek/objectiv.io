...
APIs to factor and bind the appropriate [Location Context](/taxonomy/location-contexts/overview.md) instance to the target [Trackable Element](/tracking/api-reference/advanced/elements.md#trackable-elements) via [Tracking Attributes](/tracking/api-reference/interfaces/TrackingAttributes.md).
